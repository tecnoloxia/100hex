...
//    diferenza=0;
//    
//    w= polygon==true? 1.2 : n==1? 2 : diferenza>0?  0.4 : 0.8 ;
//    bordo= diferenza>0? 3 : w;
//    
//    a=hex*cos(30)-bordo/2;
//    b=hex-bordo/2/cos(30)/cos(45);
...
//    diferenza=0;
//    
//    w= polygon==true? 1.2 : n==1? 2 : n==2? 1.6 : n==3? 1.2 : n==4? 1.2 : 0.4 ;
//    bordo=w;
//    
...
//    diferenza=1;   // 0,1
//    
//    w= polygon==true? 1.2 : n<=2? 2 : n<=4? 1.6 : n<6? 1.2 : n<=7? 0.8 : 0.4 ;
//    bordo= diferenza>0? 3 : w;
//    
//    b=hex-bordo/2/cos(30);
//    
...
//    diferenza=2;   // 0, 2
//    
//    w= n<=3? 2 : n==4? 1.6 : n<=6? 1.2 : n==7? 0.8 : 0.4 ;
//    bordo= diferenza>0? 2 : w;
//    
//    a=hex*cos(30)-bordo/2;
//    b=hex-bordo/2/cos(30);
...
//    
//    w= diferenza==2? 0.4 : n<=3? 2 : n<=7? 1.6 : n<=9? 1.2 : n==10? 0.8 : 0.4 ;
//    bordo= diferenza==2? 2 : w;
//    
//    a=hex*cos(30)-bordo/2;
//    b=hex-bordo/2/cos(30)/cos(45);
//          
...
//    diferenza=1;  // 0,1
//    
//    w= diferenza==1? 0.8 : n<3? 2 : n==3? 1.6 : 1.2;
...
//    diferenza=1;
//    
//    w= n==1? 2 : n==2? 2 : n==3? 1.6 : n==4? 1.2 : 0.8;
//    bordo= diferenza>0? 4 : w;
//    
...
//    diferenza=1;       // 0,1, 2
//        
//    w= diferenza==2? 0.01 : n==1? 2 : n==2? 2 : n==3? 1.6 : n==4? 1.2 : 0.8;
//    bordo= diferenza>0? 4 : w;
//    
...
//    
//    w=
//    diferenza==0? n<3? 2 : n==3? 1.6 : n==4? 1.2 : 0.8 :
...
//    diferenza= 1;  //0,1
//    
//    w= n==1? 2 : n==2? diferenza>0? 0.8 : 1.6 : 0.8;
//    bordo= diferenza>0? 4 : w;
//    
//    a= hex*cos(30)-bordo/2/cos(45);
//    b= hex-bordo/2/cos(30)/cos(45);
...
//    diferenza= 2;   // 0, 2
//    
//    w= (n<3)? 2 : (n==3)? 1.6 : (n==4)? 0.8 : diferenza==2? 0.4 : 0.8;
//    bordo=  w ;
//     
...
//
//    
//    w= (n==1)? 2 :(n==2)? 2 : (n==3)? 1.6 :  (n==4)? 1.6 : 0.8;
...
//    diferenza= 0;     // 0,1
//    
//    w= (n<5)? 1.6 : (n==5)? 1.2  : 0.8;
//    bordo=  (polygon==true)? diferenza==0? 1.6 : 2 : w ;
//    
//    a=hex*cos(30)-bordo/2;
//       
//    d= 
...
//    diferenza=1;       // 0,1
//    
//    w= (diferenza>0)? (n<=2)? 1.2 : 0.8 : (n<=2)? 2 : 1.6;
//    bordo= (diferenza>0)? 3 : w;
//    
//    a=(hex*cos(30)-bordo/2/cos(45));   
//    
...
//    angle=36;
//
//    n=4;        // hexagon:1->3 ; curve: max 6
//    
//    hexagono= n>5? false : true;
//    polygon= false; 
//    diferenza=0;
//    
//    w= (n==1)? 2 : (n<=3)? 1.6 : (n==4)? 1.2 :  0.8;    
//    bordo= w;
//    
//    a=(hex*cos(30)-bordo/2);
//        
...
//    diferenza=2;  // 0,2
//    
//    w= diferenza==2? 0.4 :(n<5)? 1.6 : (n<7)? 1.2 : 0.8;
//    bordo= diferenza>0? 2 : w;
//    
//    rot= 90;  // 0,90
//    
...
//    diferenza=0;   // 0,2
//    
//    w= diferenza==2? 0.4 : (n<=2)? 2 : (n==3)? 1.6 : (n==4)? 1.2 : 0.4 ;
//    bordo= diferenza==2? 2 : w;
//    
//    rot= 0; 
// 
...
//    diferenza=0;  // 0,2
//    
//    w=  diferenza==2? 0.4 : (n<3)? 2 : (n==3)? 1.6 : (n==4)? 1.2 : 0.8 ;
//    bordo= diferenza==2? 2 : w;
//    
//    rot= 0;  
//    
...
//    diferenza=1;       // 0,1
//    
//    w=  (n<3)? 2 : (n==3)? 1.2 : (n==4)? polygon==false? 0.8 : 1.2 : 0.4 ;
//    bordo= diferenza>0? 3 : w;
//    
//    rot= 0;  
//  
...
//    diferenza=0; // 0,2
//    
//    w= diferenza==2? 0.4 : (n<2)? 2 :(n==2)? 1.6 : 0.8 ;
//    bordo= diferenza==2? 2 : w;
//       
//    rot= 0;  
//  
...
//    diferenza=1;      // 0,1
//    
//    w=  (n<=2)? 2 : (n==3)? polygon==true? 1.2 : 1.6 : 0.8 ;
//    bordo= diferenza>0? 2 :  w;
//       
//    rot= 0;  
//  
...
//    diferenza=0;   // 0,2
//    
//    w=  (n==1)? 2 : (n==2)? diferenza>0? 0.8 :1.2 : 0.8 ;
//    bordo= diferenza>0? 2.4 : w;
//       
//    rot= 0;  
//  
...
//    diferenza=0;    // 0,1
//    
//    w= diferenza==1? 0.8 : (n<=2)? 2 : n==3?  1.2 : 0.8;
